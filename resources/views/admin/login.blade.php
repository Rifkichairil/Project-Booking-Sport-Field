...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Login Admin - Sportcorner </title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="text-center w-75 m-auto">
                                ...
                                <form action="{{route('core.auth')}}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-primary btn-block btn-confirm" type="submit"> Log In </button>
                                    </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <p class="text-white-50">Don't have an account? <a href="{{route('core.register')}}" class="text-white ml-1"><b>Sign Up</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
