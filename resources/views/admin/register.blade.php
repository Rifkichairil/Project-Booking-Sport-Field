...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Register Admin - Sportcorner</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <form action="{{route('core.store')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    {{-- <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="text" name="role_id" placeholder="your role_id" value="1" hidden>
                                            <input type="text" name="status" placeholder="your status" value="0" hidden>
                                            <input type="text" name="account" placeholder="your account" value="50" hidden>
                                            <input type="text" name="is_email" placeholder="your is_email" value="0" hidden>
                                        </div>
                                    </div> --}}
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Already have account?  <a href="{{route('core.login')}}" class="text-white ml-1"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
