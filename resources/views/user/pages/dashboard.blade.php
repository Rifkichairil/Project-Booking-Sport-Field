        ...
        <div class="container-fluid">
            ...
            <div class="row">
                            <div class="col-lg-12 mt-2">
                                <div class="search-result-box m-t-30 card-box">
                                    <div class="row">
                                        <div class="col-xl-5 offset-1">
                                            <div class="pt-2 pb-4">
                                                        <div class="text-left">
                                                            ...
                                                            <p>Sportcorner adalah sebuah platform yang menghubungkan user dengan pemilik lapangan bertujuan memudahkan keduanya dalam melakukan transaksi penyewaan lapangan.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-5 offset-1">
                                            <div class="pt-2 pb-2">
                                                        <img src="http://sportcorner.test/bold/assets/images/asset56.png" alt="" height="280px">
                                            </div>
                                        </div>
                             ...
                             <div class=" col-sm-3 ">
                                ...
                                <div class="card-body text-center">
                                                <span class="card-pricing-icon text-primary">
                                                    <i class="fe-search font-24"></i>
                                                </span>
                                            </div>
                                    <p class=" font-13 text-center">
                                        Mempermudah pencarian lapangan yang kamu inginkan
                                    </p>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card-body text-center">
                                                <span class="card-pricing-icon text-primary">
                                                    <i class="fe-award font-24"></i>
                                                </span>
                                            </div>
                                    <p class=" font-13 text-center"> Memiliki kesempatan untuk menjadi pemenang dalam lomba
                                    </p>
                                </div> 
                                </div> <!-- end card-box -->
                                        </div>
